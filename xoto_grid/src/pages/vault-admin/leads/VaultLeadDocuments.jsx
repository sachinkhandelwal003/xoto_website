          ...
          {existing ? (
            ...
            <>
              <div style={{ fontSize: 13, color: dragOver ? PRIMARY : '#6b7280', fontWeight: 500 }}>
                ðŸ“‚ {dragOver ? 'Drop to upload' : 'Drag & drop or click to browse'}
              </div>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ fontSize: 13, color: '#6b7280' }}>
                    ...
                    {categoryDocs.filter(d => d.required).length > 0 && ` Â· ${categoryDocs.filter(d => d.required && documents.some(ud => (ud.documentType || ud.document_type) === d.type)).length}/${categoryDocs.filter(d => d.required).length} required`}
                  </div>
                </div>
              </div>
