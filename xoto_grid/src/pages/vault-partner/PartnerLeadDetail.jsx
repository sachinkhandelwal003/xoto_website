...
const STATUS_CFG = {
  "New": { bg: "#EFF6FF", color: "#1D4ED8", border: "#93C5FD", order: 0 },
  "Assigned": { bg: C.primarySoft, color: C.primary, border: C.primaryBord, order: 1 },
  "Contacted": { bg: "#FFF7ED", color: "#C2410C", border: "#FED7AA", order: 2 },
  "Qualified": { bg: "#EEF2FF", color: "#4338CA", border: "#C7D2FE", order: 3 },
  "Collecting Documents": { bg: "#FAF5FF", color: "#581C87", border: "#E9D5FF", order: 4 },
  "Bank Application": { bg: "#EDE9FE", color: "#5B21B6", border: "#C7D2FE", order: 5 },
  "Pre-Approved": { bg: "#DCFCE7", color: "#166534", border: "#BBF7D0", order: 6 },
  "Valuation": { bg: "#FEF3C7", color: "#92400E", border: "#FDE68A", order: 7 },
  "FOL Processed": { bg: "#E0E7FF", color: "#3730A3", border: "#C7D2FE", order: 8 },
  "FOL Issued": { bg: "#E0E7FF", color: "#3730A3", border: "#C7D2FE", order: 9 },
  "FOL Signed": { bg: "#F3E8FF", color: "#6B21A5", border: "#E9D5FF", order: 10 },
  "Disbursed": { bg: C.greenSoft, color: C.green, border: C.greenBord, order: 11 },
  "Lost": { bg: C.redSoft, color: C.red, border: C.redBord, order: 99 },
};

// Status options for dropdown (PRD Section 6.1)
const STATUS_OPTIONS = [
  "Assigned", "Contacted", "Qualified", "Collecting Documents",
  "Bank Application", "Pre-Approved", "Valuation", "FOL Processed",
  "FOL Issued", "FOL Signed", "Disbursed", "Lost"
];
...
export default function PartnerLeadDetail() {
  ...
  // Lead is locked once a case is created — status auto-managed by case workflow
  const isLeadLocked = cv?.convertedToApplication === true;

  const getAvailableStatuses = () => {
    if (isLeadLocked) return [];
    return ["Contacted", "Qualified", "Collecting Documents", "Documents Complete"]
