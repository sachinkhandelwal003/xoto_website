...
const MyProfileB2C = () => {
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      await apiService.put('/vendor/b2c/change-password', passwordData);
  ...
  const handleFileChange = async (e) => {
    ...
    try {
      await apiService.put(`/vendor/b2c/document/${updatingDocument}`, formData, {
  ...
  const getDocumentsArray = () => {
    ...
    if (vendor.documents.identity_proof) {
      documents.push({ ...vendor.documents.identity_proof, _id: vendor.documents.identity_proof._id || 'identity_proof', type: 'identity_proof' });
    }
    if (vendor.documents.address_proof) {
      documents.push({ ...vendor.documents.address_proof, _id: vendor.documents.address_proof._id || 'address_proof', type: 'address_proof' });
    }
    if (vendor.documents.gst_certificate) {
      documents.push({ ...vendor.documents.gst_certificate, _id: vendor.documents.gst_certificate._id || 'gst_certificate', type: 'gst_certificate' });
    }
    return documents;
  };
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg transition-transform duration-300 hover:scale-[1.02]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-gray-900 font-medium">{vendor.store_details?.store_name || '--'}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-medium">{vendor.store_details?.store_type || '--'}</p>
                </div>
                <div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg transition-transform duration-300 hover:scale-[1.02]">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  ...
                  <p className="text-gray-900 font-medium">{vendor.store_details?.store_address || '--'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Pincode</label>
                  <p className="text-gray-900 font-medium">{vendor.store_details?.pincode || '--'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Store Description</label>
                  <p className="text-gray-900 font-medium">{vendor.store_details?.store_description || '--'}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg transition-transform duration-300 hover:scale-[1.02]">
              ...
              {vendor.store_details?.categories && vendor.store_details.categories.length > 0 ? (
                <div className="space-y-4">
                  {vendor.store_details.categories.map((category, index) => (
