          ...
          <Canvas camera={{ position: [0, 1.45, 1.05], fov: 38 }}>
            ...
            <Suspense fallback={null}>
              <Avatar
                ...
                audioRef={audioRef}
                language={selectedLang}
                phonemeTiming={phonemeTiming} // ← PASS PHONEME TIMING
              />
      ...
      <div style={styles.panel}>
        ...
        <div style={styles.inputArea}>
          <input 
            ...
            disabled={status === 'listening' || status === 'thinking' || audioLoading}
          />
          <button 
            onClick={() => handleSendText()} 
            style={styles.sendButton}
            disabled={!inputText.trim() || status === 'listening' || status === 'thinking' || audioLoading}
          >
            Ask
          </button>
        </div>
        ...
        <div style={styles.speechControls}>
          <button 
            ...
            disabled={status === 'thinking' || audioLoading}
          >
