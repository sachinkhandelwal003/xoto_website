...
const EcommerceNavbar = () => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    if (searchQuery.trim()) {
      router.push(`/ecommerce/search?q=${encodeURIComponent(searchQuery)}&location=${encodeURIComponent(selectedLocation)}`);
      setSearchQuery("");
    }
  };
                          ...
                          <div className="border-t border-gray-100 mt-4 pt-4 px-6">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {category.name === "Living Room" && (
                                <>
                                  <Link href="/categories/home-furniture/living-room/sofa-sets" className="text-xs px-3 py-1 bg-gray-100 hover:bg-gray-200 rounded-full">Sofa Sets</Link>
                                  <Link href="/categories/home-furniture/living-room/sectional-sofas" className="text-xs px-3 py-1 bg-gray-100 hover:bg-gray-200 rounded-full">Sectional Sofas</Link>
                                  <Link href="/categories/home-furniture/living-room/coffee-tables" className="text-xs px-3 py-1 bg-gray-100 hover:bg-gray-200 rounded-full">Coffee Tables</Link>
                                </>
                              )}
                              {category.name === "Bedroom" && (
                                <>
                                  <Link href="/categories/home-furniture/bedroom/king-size-beds" className="text-xs px-3 py-1 bg-gray-100 hover:bg-gray-200 rounded-full">King Size Beds</Link>
                                  <Link href="/categories/home-furniture/bedroom/mattresses" className="text-xs px-3 py-1 bg-gray-100 hover:bg-gray-200 rounded-full">Mattresses</Link>
                                  <Link href="/categories/home-furniture/bedroom/wardrobes" className="text-xs px-3 py-1 bg-gray-100 hover:bg-gray-200 rounded-full">Wardrobes</Link>
                                </>
                              )}
                              {category.name === "Kitchen & Dining" && (
                                <>
                                  <Link href="/categories/home-furniture/kitchen-dining/dining-sets" className="text-xs px-3 py-1 bg-gray-100 hover:bg-gray-200 rounded-full">Dining Sets</Link>
                                  <Link href="/categories/home-furniture/kitchen-dining/bar-stools" className="text-xs px-3 py-1 bg-gray-100 hover:bg-gray-200 rounded-full">Bar Stools</Link>
                                  <Link href="/categories/home-furniture/kitchen-dining/kitchen-islands" className="text-xs px-3 py-1 bg-gray-100 hover:bg-gray-200 rounded-full">Kitchen Islands</Link>
                                </>
                              )}
                            </div>
                          </div>
